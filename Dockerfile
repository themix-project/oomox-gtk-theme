...
RUN pacman -Syu --noconfirm && \
    ...
    pacman -S --needed --noconfirm ttf-roboto scrot xorg-server-xvfb libfaketime xdotool parallel gnome-themes-extra adwaita-icon-theme openbox xorg-xrdb xorg-xsetroot imagemagick shellcheck noto-fonts && \
    rm -fr /var/cache/pacman/pkg/ /var/lib/pacman/sync/
